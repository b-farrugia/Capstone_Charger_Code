...
void Init_Peripherals() {
    ...
    GPIO_writePin(DEVICE_GPIO_PIN_MCU_FLT, 0);
...
void Init_GPIO() {
    ...
    // P1
    GPIO_Config(DEVICE_GPIO_PIN_P1H_FAULT, DEVICE_GPIO_CFG_P1H_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);
    GPIO_Config(DEVICE_GPIO_PIN_P1L_FAULT, DEVICE_GPIO_CFG_P1L_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);

    // P2
    GPIO_Config(DEVICE_GPIO_PIN_P1H_FAULT, DEVICE_GPIO_CFG_P2H_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);
    GPIO_Config(DEVICE_GPIO_PIN_P1L_FAULT, DEVICE_GPIO_CFG_P2L_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);

    // P3
    GPIO_Config(DEVICE_GPIO_PIN_P3H_FAULT, DEVICE_GPIO_CFG_P3H_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);
    GPIO_Config(DEVICE_GPIO_PIN_P3L_FAULT, DEVICE_GPIO_CFG_P3L_FAULT, GPIO_DIR_MODE_IN, GPIO_PIN_TYPE_PULLUP,
                GPIO_QUAL_ASYNC);
